...
const HistoricalWordRow: React.FC<HistoricalWordRowProps> = ({
  card,
  showTranslations,
  onPress,
  isFirst,
    ...
    <GestureHandlerRootView>
      ...
      <Swipeable renderRightActions={renderRightActions}>
        <TouchableOpacity
          onPress={onPress}
          style={[
            tw` ${theme.classes.backgroundTertiary} border ${theme.classes.borderPrimary} ${isLast ? '' : 'border-b-0'}`,
...
export default HistoricalWordRow;
